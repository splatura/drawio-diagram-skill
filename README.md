...
A coding agent skill that generates beautiful and practical draw.io diagrams from natural language descriptions. Not just boxes-and-arrows - diagrams that **argue visually**.
...
- **Universal format.** Draw.io files open in [diagrams.net](https://app.diagrams.net), VS Code extensions, Confluence, Notion, and many other tools.
...
Just tell your agent: *"Set up the draw.io diagram skill renderer by following the instructions in SKILL.md."* It will run the commands for you.
...
> "Create a draw.io diagram showing how the AG-UI protocol streams events from an AI agent to a frontend UI"

The skill handles the rest — concept mapping, layout, XML generation, rendering, and visual validation.
...
drawio-diagram/
  ...
  references/
    ...
    element-templates.md            # XML templates for each element type
    json-schema.md                  # Draw.io XML format reference
    render_drawio.py                # Render .drawio to PNG
